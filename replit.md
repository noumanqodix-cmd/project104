...
- **Real-Time RIR-Based Recommendations**: During rest periods between sets, system tracks Reps in Reserve (RIR)
  - **For weighted exercises**: If RIR > 2, suggests adding weight for next set:
    - RIR 3-4: Add 5 lbs
    - RIR 5+: Add 10 lbs
    - Recommendation appears as banner and updates the weight input placeholder automatically
  - **For bodyweight exercises**: If RIR > 2, suggests adding 1 rep for next set:
    - Recommendation appears as banner and updates the reps input placeholder automatically
