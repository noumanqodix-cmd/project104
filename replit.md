...
- **Template-Based Adaptive Training System**:
  ...
  - **Percentage-Based Time Allocation System**: Uses allocation matrix mapping nutrition goal × workout duration to component percentages. All workouts scale consistently: Warmup (5-8%), Power (15-20%), Strength (48-65%), Cardio (5-30%). System ensures optimal time utilization across all duration and goal combinations while maintaining training priorities.
    - **GAIN Matrix**: Prioritizes strength volume, minimal cardio. 30min (5%w, 20%p, 65%s, 5%c), 45min (6%w, 17%p, 63%s, 8%c), 60min (7%w, 15%p, 60%s, 10%c), 90min (8%w, 15%p, 58%s, 12%c).
    - **MAINTAIN Matrix**: Balanced strength and cardio. 30min (5%w, 20%p, 60%s, 12%c), 45min (6%w, 17%p, 58%s, 15%c), 60min (7%w, 15%p, 55%s, 18%c), 90min (8%w, 15%p, 52%s, 20%c).
    - **LOSE Matrix**: Maximizes cardio for calorie burn. 30min (5%w, 20%p, 55%s, 20%c), 45min (6%w, 17%p, 53%s, 23%c), 60min (7%w, 15%p, 50%s, 25%c), 90min (8%w, 15%p, 48%s, 28%c).
    - Percentages convert to time budgets (e.g., 60min LOSE: 4.2min warmup, 9min power, 30min strength, 15min cardio). Exercise counts determined by dividing budget by exercise time estimates.
