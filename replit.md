...
- **Comprehensive Fitness Assessment System**: Onboarding supports Bodyweight Test, Weights Test, or an option to skip. Assessment data maps to 8 independent movement patterns for precise difficulty filtering. Collects `daysPerWeek` (strictly 3, 4, or 5 days only), `selectedDays`, and comprehensive equipment selection (17 options). Session duration options: 30, 45, 60, or 90 minutes.
